...
import '../search-input';
import type { ArtSearchInput } from '../search-input';
...
export default meta;
type Story = StoryObj<IArtSearchInput>;

const Template = (args: IArtSearchInput) => {
  return html`
    <div class="w-[250px]">
      <art-search-input
        id="${args.name}"
...
export const Default: Story = {
  ...
  play: async ({ canvasElement }) => {
    const component = canvasElement.querySelector('art-search-input') as ArtSearchInput;
